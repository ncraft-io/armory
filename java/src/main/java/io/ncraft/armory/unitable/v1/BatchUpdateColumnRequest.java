...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      BatchUpdateColumnRequest.class.getName());
  }
  // Use BatchUpdateColumnRequest.newBuilder() to construct.
  private BatchUpdateColumnRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.ncraft.armory.unitable.v1.BatchUpdateColumnRequest result) {
      if (columnsBuilder_ == null) {
    ...
    private void buildPartial0(io.ncraft.armory.unitable.v1.BatchUpdateColumnRequest result) {
