...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      BatchUpdateRowsRequest.class.getName());
  }
  // Use BatchUpdateRowsRequest.newBuilder() to construct.
  private BatchUpdateRowsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.ncraft.armory.unitable.v1.BatchUpdateRowsRequest result) {
      if (rowsBuilder_ == null) {
    ...
    private void buildPartial0(io.ncraft.armory.unitable.v1.BatchUpdateRowsRequest result) {
