...
const (
	Unitable_ListDatabases_FullMethodName      = "/armory.unitable.v1.Unitable/list_databases"
...
func (c *unitableClient) ListDatabases(ctx context.Context, in *ListDatabasesRequest, opts ...grpc.CallOption) (*ListDatabasesResponse, error) {
	out := new(ListDatabasesResponse)
	err := c.cc.Invoke(ctx, Unitable_ListDatabases_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *unitableClient) GetRowStat(ctx context.Context, in *GetRowStatRequest, opts ...grpc.CallOption) (*core.Object, error) {
	out := new(core.Object)
	err := c.cc.Invoke(ctx, Unitable_GetRowStat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUnitableServer) ListDatabases(context.Context, *ListDatabasesRequest) (*ListDatabasesResponse, error) {
...
func (UnimplementedUnitableServer) GetRowStat(context.Context, *GetRowStatRequest) (*core.Object, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRowStat not implemented")
}
...
func _Unitable_ListDatabases_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDatabasesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UnitableServer).ListDatabases(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Unitable_ListDatabases_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UnitableServer).ListDatabases(ctx, req.(*ListDatabasesRequest))
	}
...
func _Unitable_GetRowStat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRowStatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UnitableServer).GetRowStat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Unitable_GetRowStat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UnitableServer).GetRowStat(ctx, req.(*GetRowStatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Unitable_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "list_databases",
			Handler:    _Unitable_ListDatabases_Handler,
		},
		{
		...
		{
			MethodName: "get_row_stat",
			Handler:    _Unitable_GetRowStat_Handler,
		},
		{
