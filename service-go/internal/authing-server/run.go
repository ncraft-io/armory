...
func NewEndpoints(options map[string]interface{}, services ...pb.AuthingServer) svc.Endpoints {
	// Business domain.
...
func RegisterService(cfg nserver.Config, r *mux.Router, s *grpc.Server, services ...pb.AuthingServer) svc.Endpoints {
	// tracing init
